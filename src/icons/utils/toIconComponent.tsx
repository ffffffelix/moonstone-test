...
const toComp = (node: HTMLElement, idx: string) => {
    if (node.nodeType === 1) {
        ...
        const children = Array.prototype.slice.call(node.childNodes).map((child: HTMLElement, idxChild: string) => toComp(child, idxChild));
